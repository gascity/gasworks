...
//  2. Strip a single pair of surrounding brackets. If the result parses as an IP, return
//     Go's normalized form (a v4-mapped IPv6 collapses to a dotted quad; IPv6 is lowercased
//     and compressed).
//  3. Otherwise strip exactly one trailing dot and run IDNA ToASCII (the Lookup profile,
//     which case-folds and normalizes); reject on any IDNA error.
//
