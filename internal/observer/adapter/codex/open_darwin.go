...
// openGCMetaSidecar walks a sidecar locator from the trusted root descriptor without following any
// symlink. The caller fstats and validates the small regular sidecar value.
